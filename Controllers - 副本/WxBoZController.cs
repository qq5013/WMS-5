    ...
    public class WxBoZController : SsnController
    {
        ...
        /*public ActionResult BokBozBll(String wmsno)
        {
            ...
            foreach (var bzdtl in bzdtls)
            {
                ...
                {
                    return RInfo( "I0416",bzdtl.gdsid,bzdtl.qty ,bzdtl.preqty );
                }
                //如果播种明细小于应收数量， 生成损溢数量                
                if (bzdtl.qty < bzdtl.preqty)
                {
            ...
            */
            ...
            try
            {
                ...
                */
                ...
                WmsDc.SubmitChanges();
                return RSucc("成功", null, "S0201");
            }
            catch (Exception ex)
            {
                return RErr(ex.Message, "E0055");
            }
        }        
        ...
        public ActionResult GetBoZBllSummary(String wmsno)
        {
            ...
            if (wmsno1.Length <= 0)
            {
                return RNoData("N0222");
            }

            return RSucc("成功!", wmsno1, "S0202");
        }
        ...
        public ActionResult GetBoZBllTop20(String wmsno)
        {
            ...
            if (wmsno1.Length <= 0)
            {
                return RNoData("N0223");
            }

            return RSucc("成功！", wmsno1, "S0203");
        }
        ...
        public ActionResult GetBoZBllByGdsid(String wmsno, String gdsid)
        {
            ...
            if (wmsno1.Length <= 0)
            {
                return RNoData("N0224");
            }

            return RSucc("成功", wmsno1, "S0204");
        }
        ...
        {            
            ...
            {
                return RNoData("N0225");
            }

            return RSucc("成功", arrqrymst, "S0205");
        }
