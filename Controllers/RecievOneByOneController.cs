...
namespace WMS.Controllers
{
    ...
    public class RecievOneByOneController : SsnController
    {
        ...
        public ActionResult BokRecievGds(String wmsno, String gdsid, String gdstypes, String qtys, String tpcodes, String pkgids, String vlddat)
        {
            ...
            using (TransactionScope scop = new TransactionScope(TransactionScopeOption.Required, options))
            {
                ...
                try
                {
                    ...
                    return RSucc("成功", null, "S0220");

                }
                catch (Exception ex)
                {
                    return RErr(ex.Message, "E0030");
                }
            }
        }
        ...
        private ActionResult DoActByRcvbll(String wmsno, String qu, String savdptid, Func<string, ResultMessage> func)
        {
            ...
            {
                return MakeNewBllNo(LoginInfo.DefSavdptid, qu, WMSConst.BLL_TYPE_UPBLL, func);
            }
        }
        ...
        public ActionResult FindBll(String begindat, String enddat, String wmsno, String gdsid, String barcode, String prvid, String dptid)
        {
            ...
            {
                return RInfo( "I0241",barcode.Trim()  );
            }
            ...
            {
                return RNoData("N0131");
            }
            return RSucc("成功", arrqrymst, "S0116");
        }
        ...
        public ActionResult FindCurrDayRcvBlls(String day)
        {
            ...
            return RSucc("成功", qry.ToArray(), "S0118");
        }
        ...
        public ActionResult GetRecievBll(String wmsno)
        {
            ...
            if (arrqry.Length <= 0)
            {
                return RNoData("N0132");
            }

            return RSucc("成功", arrqry[0], "S0119");
        }
        ...
        public ActionResult FindUnAdtRecievBll(char chkflg, String prvid, String bdtm, String edtm)
        {
            ...
            if (bllmsts.Length <= 0)
            {
                return RNoData("N0133");
            }

            return RSucc("成功", bllmsts, "S0120");
        }
        ...
        public ActionResult GenerateRecievBll(String odrno)
        {
            ...
            string qu = GetQuByDptid(arrqry[0].mst.dptid, LoginInfo.DefStoreid);
            return MakeNewBllNo(
                ...
                ((bllno) =>
                {
                    ...
                    foreach (odrdtl dtl in odr.dtl)
                    {
                        if (dtl.qty != 0)
                        {
                            ...
                            blldtl.bthno = dtl.bthno == null ? "1" : dtl.bthno;
                            blldtl.vlddat = dtl.vlddat == null ? GetCurrentDay() : dtl.vlddat;
        ...
        public ActionResult BokReciev(String wmsno)
        {
            ...
            {
                return RInfo( "I0248",hsQty[0] );
            }

            //1.是否该单据下的所有商品都已经审核                        
            if (tps.Length <= 0 && hsQty.Length > 0)
            {
                return RNoData("N0136");
            }
            else
            {
                foreach (wms_blltp tp in tps)
                {
                    if (tp.bokflg == GetN())
                    {
                        return RInfo(tp.tpcode + ",该托盘还未完成收货确认操作！", "I0249");
                    }
                }
            }
            #endregion
            ...
            return DoActByRcvbll(wmsno, mst.qu, mst.savdptid, (bllno) =>
            {
                ...
                //{
                //    return RRInfo( "I0250",arrqryodrdtl[0].gdsid );
                //}
                ...
                try
                {
                    ...
                    return RRSucc("成功", null, "S0121");
                }
                catch (Exception ex)
                {
                    return RRErr(ex.Source + ex.Message, "E0032");
                }
        ...
        public ActionResult ListTpByGdsid(String wmsno, String gdsid, String gdstype, String vlddat)
        {
            ...
            var qrysh = from e in WmsDc.wms_blltp
                        ...
                        && e.bllid == WMSConst.BLL_TYPE_REVIECEBLL
                        select e;
            return RSucc("成功", qrysh.ToArray(), "S0122");
        }
        ...
        public ActionResult BokRecievByTp(String wmsno, String tpcode)
        {
            using (TransactionScope scop = new TransactionScope(TransactionScopeOption.Required, options))
            {
                ...
                if (mst == null) { return RNoData("N0141"); }
                ////正在生成拣货单，请稍候重试
                //string quRetrv = mst.qu;
                //if (DoingRetrieve(LoginInfo.DefStoreid, quRetrv))
                //{
                ...
                {
                    scop.Complete();
                    return RSucc("成功", lstObj, "S0126");
                }
                catch (Exception ex)
                {
                    return RErr(ex.Message, "E0033");
                }
        ...
        public ActionResult AdGdsByTps(String wmsno, String gdsids, String gdstypes, String qtys, String tpcode, String pkgids)
        {
            using (TransactionScope scop = new TransactionScope(TransactionScopeOption.Required, options))
            {
                ...
                {
                    scop.Complete();
                    return RSucc("成功", lstObj, "S0127");
                    
                }
                catch (Exception ex)
                {
                    return RErr(ex.Message, "E0034");
                }
            }
        }
        ...
        private ResultMessage AddUpShelfDtlAndSuggestBarcode(string bllno, string qu, string wmsno, string gdsid, string pkgid, double iqty, string gdstype, string tpcode)
        {
            ...
            wms_blldtl blldtl = (from e in WmsDc.wms_blldtl
                                 ...
                                 where e.wmsno == wmsno && e.bllid == WMSConst.BLL_TYPE_REVIECEBLL
                                 && e.gdsid == gdsid && e1.tpcode == tpcode
                                 select e).FirstOrDefault();
            ...
            newdtl.bthno = string.IsNullOrEmpty(blldtl.bthno)?"1":blldtl.bthno;
            newdtl.vlddat = string.IsNullOrEmpty(blldtl.vlddat) ? GetCurrentDay() : blldtl.vlddat;
            ...
            try{
                WmsDc.SubmitChanges();
                return RRSucc("成功", newdtl, "S0128");
            }catch(Exception ex){
                return RRErr(ex.Message, "E0035");
            }            
        }
        ...
        private string SuggestABarcodeByTpcode(String wmsno, string qu, string savdptid)
        {
            ...
            wms_cangwei[] cws = (from e in WmsDc.wms_cangwei
                              where e.savdptid == savdptid && e.isvld == GetY() && e.qu == qu
                              && e.tjflg == GetY() && e.tpflg == GetN() && e.kcflg == '0'
            ...
            wms_cangwei[] arrcw = (from e in cws
                              ...
                              select e).ToArray();
            //随机获取 最小层下面的一个可推荐仓位
            Random rdcw = new Random();
            int iRd = rdcw.Next(0, arrcw.Length);
            wms_cangwei cw = arrcw[iRd];           
        ...
        public ActionResult AdGdsByTp(String wmsno, String gdsid, String gdstype, String qty, String tpcode, String pkgid)
        {
            ...
            {
                //scop.Complete();
                return RSucc("成功", Rm.ResultObject, "S0130");
            }
            catch (Exception ex)
            {
                return RErr(ex.Message, "E0036");
            }
            //}
        }
        ...
        public ActionResult DlGdsByTp(String wmsno, String tpcode)
        {
            ...
            try
            {
                ...
                WmsDc.SubmitChanges();
                return RSucc("成功", null, "S0131");
            }
            catch (Exception ex)
            {
                return RErr(ex.Message, "E0037");
            }
        ...
        public ActionResult GetGdsByTpcode(String wmsno, String tpcode, String bokdat)
        {
            ...
            {
                return RNoData("N0145");
            }
            return RSucc("成功", arrqryDtlTp, "S0132");
        }
        ...
        private ResultMessage InstAGdsTp(String wmsno, String gdsid, String gdstype, String tpcode, String pkgid, double iqty, wms_bllmst mst)
        {
            ...
            if (idxDtp == null)
            {
                return RRInfo( "I0279",wmsno ,gdsid  );
            }
            int iIdx = 0;
            iIdx = idxDtp.rcdidx;
            int iTpIdx = 1000;
            ...
            WmsDc.SubmitChanges();
            return RRSucc("成功", newdtltp, "S0133");
        }
        ...
        private ResultMessage TpHasUnBoked(String wmsno, String tpcode)
        {
            ...
            {
                return RRInfo( "I0282",tpcode  );
            }
            return RRSucc("尚未确认", null, "S0134");
        }
        ...
        public ActionResult MdfyRecievGdsType(String wmsno, String gdsid, String gdstype, String newgdstype)
        {
            ...
            try
            {
                ...
                return RSucc("成功", arrqry[0], "S0135");
            }
            catch (Exception ex)
            {
                return RErr(ex.Message, "E0038");
            }
        }
    }
}
